...
export const metadata: Metadata = {
  ...
  description: 'Ayurmor crafts 100% natural, organic botanical health mixes including Moringa Premix Soup, ABC Malt Powder (Apple, Beetroot, Carrot), and Choco Multigrain Millet Malt. FSSAI Reg. No. 21224169000054 & ISO 9001:2015 Certified. Free Shipping & Cash on Delivery across India.',
  keywords: [
    'Ayurmor', 'Moringa Soup', 'ABC Malt Powder', 'Choco Millet Malt', 
    'Sprouted Millets', 'Organic Health Mix', 'FSSAI Certified', 'Natural Detox Soup', 
  ...
  openGraph: {
    ...
    description: '100% organic, zero-refined-sugar botanical mixes and instant soups. FSSAI Registered & ISO 9001:2015 Certified.',
...
const jsonLd = {
  ...
  'description': 'Manufacturer of premium organic botanical health mixes, instant Moringa soup, and sprouted millet malts.',
  'address': {
    '@type': 'PostalAddress',
